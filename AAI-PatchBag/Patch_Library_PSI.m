%%%% Patch Preprocessing
% Load Patch Merge
load('Reduced_Sample_nInt_Res_Results/Unique_Patch_Merge_PSI.mat');
...
save('Reduced_Sample_nInt_Res_Results/Patch_Library_DISM.mat', 'Patch_Library_DISM');
...
load('Reduced_Sample_nInt_Res_Results/Patch_Library_DISM.mat')
...
% Medoid
load('Reduced_Sample_nInt_Res_Results/Patch_Library_8000.mat')
Clust_medoids=Patch_Library_8000(C);

save('Reduced_Sample_nInt_Res_Results/Clust_medoids_300.mat', 'Clust_medoids');
