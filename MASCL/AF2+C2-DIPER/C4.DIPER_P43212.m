...
save('C4.DIPER_Result/C4_DIPER_Result_P43212.mat', 'Sample');
...
load('C2.DIPER_Result/P43212_C2_TopRank_Result.mat')
...
save('C4.DIPER_Result/C4_TopRank_Result_P43212.mat', 'C4_TopRank_Result');
...
save('C4.DIPER_Result/P43212_TopRank_Result.mat', 'Result');
...
mkdir('C4.DIPER_Result/P43212_TopRank_300_Pose');

% Load C4.DIPER Result
load('C4.DIPER_Result/P43212_TopRank_Result.mat');
load('C2.DIPER_Result/P43212_C2_TopRank_Result.mat');
...
parfor r=1:size(Result,2)
    ...
    % Establish Deposited File
    mkdir(['C4.DIPER_Result/P43212_TopRank_300_Pose/',Result(r).ID]);
    ...
    if ~isempty(Qualified_Idx)
        for QI=1:size(Qualified_Idx,1)
            ...
            warning('off','all');
            pdbwrite(['C4.DIPER_Result/P43212_TopRank_300_Pose/', Result(r).ID, '/', HMD_ID, set(3:7), num2str(Result_Idx), '.pdb'], Output_SiXt);
            ...
            warning('off','all');
            pdbwrite(['C4.DIPER_Result/P43212_TopRank_300_Pose/', Result(r).ID, '/', HMD_ID, set(3:7), num2str(Result_Idx), '_C2C4.pdb'], Output_C2C4);
            ...
            warning('off','all');
            pdbwrite(['C4.DIPER_Result/P43212_TopRank_300_Pose/', Result(r).ID, '/', HMD_ID, set(3:7), num2str(Result_Idx), '_Ans.pdb'], Output_Xtal);
        end
    end
    r
end
...
save('C4.DIPER_Result/P43212_Sum_Table.mat', 'Sum_Table');