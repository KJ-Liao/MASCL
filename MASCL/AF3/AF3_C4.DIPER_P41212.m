...
%%%% Default Setting
% Load PDB ID
File=fopen('Sample_prep_5cg5.txt');
Sample(1).ID=[];s=1;
while (1)
    line=fgetl(File);
    if line==-1, break, end
...
% Output
save('AF3_Dimer4Docking/AF3_C4_DIPER_Result_P41212.mat', 'Sample');
...
load('AF3_Dimer_Result/P41212_AF3_Dimer_Result.mat')
...
save('AF3_Dimer4Docking/P41212_C4_TopRank_Result.mat', 'C4_TopRank_Result');
...
save('AF3_Dimer4Docking/P41212_TopRank_Result.mat', 'Result');
...
mkdir('AF3_C4.DIPER_Result/P41212_TopRank_300_Pose');
...
parfor r=1:size(Result,2)
    ...
    % Establish Deposited File
    mkdir(['AF3_C4.DIPER_Result/P41212_TopRank_300_Pose/',Result(r).ID]);
    ...
    if ~isempty(Qualified_Idx)
        for QI=1:size(Qualified_Idx,1)
            ...
            warning('off','all');
            pdbwrite(['AF3_C4.DIPER_Result/P41212_TopRank_300_Pose/', Result(r).ID, '/', HMD_ID, set(3:7), num2str(Result_Idx), '.pdb'], Output_SiXt);
            ...
            warning('off','all');
            pdbwrite(['AF3_C4.DIPER_Result/P41212_TopRank_300_Pose/', Result(r).ID, '/', HMD_ID, set(3:7), num2str(Result_Idx), '_C2C4.pdb'], Output_C2C4);
            ...
            warning('off','all');
            pdbwrite(['AF3_C4.DIPER_Result/P41212_TopRank_300_Pose/', Result(r).ID, '/', HMD_ID, set(3:7), num2str(Result_Idx), '_Ans.pdb'], Output_Xtal);
        end
    end
    r
end
...
save('AF3_C4.DIPER_Result/P41212_Sum_Table.mat', 'Sum_Table');