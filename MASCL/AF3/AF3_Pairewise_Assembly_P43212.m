...
mkdir('AF3_Dimer_Result/P43212_AF3_Dimer_Result/')
...
for r=1:size(Sample_Info,2)
    ...
    for af=0:4
        if Table(r,af+1)<6
            ...
            mkdir(['AF3_Dimer_Result/P43212_AF3_Dimer_Result/',lower(Sample_Info(r).ID)])
            copyfile(['AF3_trun_Dimer/',lower(Sample_Info(r).ID),'/',lower(Sample_Info(r).ID),'_trun_AF_model_',num2str(af),'.pdb'],['AF3_Dimer_Result/P43212_AF3_Dimer_Result/',lower(Sample_Info(r).ID),'/',lower(Sample_Info(r).ID),'_trun_AF_model_',num2str(af),'.pdb'])

            % Extract CA Coordinate
            AF=pdbread(['AF3_Dimer_Result/P43212_AF3_Dimer_Result/',lower(Sample_Info(r).ID),'/',lower(Sample_Info(r).ID),'_trun_AF_model_',num2str(af),'.pdb']);
            Model=[AF.Model.Atom.X; AF.Model.Atom.Y; AF.Model.Atom.Z]';
            AF_CA_Idx=strcmp({AF.Model.Atom.AtomName}, 'CA')';
            AF_Model=Model(AF_CA_Idx,:);
            ...
            warning('off','all');
            pdbwrite(['AF3_Dimer_Result/P43212_AF3_Dimer_Result/',lower(Sample_Info(r).ID),'/',lower(Sample_Info(r).ID),'_trun_AF_model_',num2str(af),'_Ans.pdb'], Ans);
        end
    end
end

save ('AF3_Dimer_Result/P43212_AF3_Dimer_Result.mat', 'Table')